...
import com.example.elshare.adapter.DriverNotificationsAdapter;
...
public class AllBookingDriver extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRootView= inflater.inflate(R.layout.fragment_all_booking_driver, container, false);

        mBookingHistoryRecycleView =mRootView.findViewById(R.id.driver_all_booking_recycleview);
        mNextButton =mRootView.findViewById(R.id.NextAllBookingDriver);
        mPreviousButton =mRootView.findViewById(R.id.PreviousAllBookingDriver);
        pageCount=mRootView.findViewById(R.id.AllBookingDriverCount);
    ...
    private void initialState()
    {
        ...
        Call<HostBookingHistoryPojo> call = service.getBookingHistoryDriverNext(userId,cuurent_page);
        call.enqueue(new Callback<HostBookingHistoryPojo>() {
            ...
            public void onResponse(Call<HostBookingHistoryPojo> call, Response<HostBookingHistoryPojo> response) {
                if (response.body() != null) {
                    ...
                    mHostBookingAdapter = new hostBookingHistoryAdapter(getContext(), orderNumberArray, totalAmountArray, bookingDateArray, bookingId, bookingCount, role_string);
