...
public class DriverNotificationsAdapter extends RecyclerView.Adapter <DriverNotificationsAdapter.ViewHolder> {
    ...
    public DriverNotificationsAdapter(Context context, ArrayList<String> isRead, ArrayList<String> booking_id, ArrayList<String> listing_message, ArrayList<String> notificationId) {
        super();
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
        ...
        viewHolder.mNotification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                Call<ResponseBody> call = service.markDriverNotificationRead( notificationId.get(i));
