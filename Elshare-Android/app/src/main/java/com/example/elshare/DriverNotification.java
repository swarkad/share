...
public class DriverNotification extends Fragment {
    ...
    DriverNotificationsAdapter mNotificationAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRootView= inflater.inflate(R.layout.fragment_driver_notification, container, false);
        ...
        call.enqueue(new Callback<NotificationHostPOJO>() {
            ...
            public void onResponse(Call<NotificationHostPOJO> call, Response<NotificationHostPOJO> response) {
                ...
                if (response.body() != null) {
                    ...
                    mNotificationRecycleView =mRootView.findViewById(R.id.driver_notification_recycleview);
                    ...
                    mNotificationAdapter = new DriverNotificationsAdapter(getContext(),mNotificationIsRead,mUserBookingId,mNotificationMessage,mNotificationId);
