...
import com.example.elshare.EditCommercialListingActivity;
import com.example.elshare.R;
import com.example.elshare.list_commertial;
...
public class CommercialListingCustomAdapter extends RecyclerView.Adapter<CommercialListingCustomAdapter.MyViewHolder> {
    Dialog showListingDialog;
    private ArrayList<DataModel> dataSet;
    private CommercialListingCustomAdapter.ItemOnClickListner mListner;
    private show_commertial showCommercialObject;
    private StringBuilder dayWithTimeStringBuilder = new StringBuilder("");

    public CommercialListingCustomAdapter(ArrayList<DataModel> data) {
        this.dataSet = data;
    }

    public void setItemOnClickListner(CommercialListingCustomAdapter.ItemOnClickListner listner) {
        mListner = listner;
    }

    @Override
    public CommercialListingCustomAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        CommercialListingCustomAdapter.MyViewHolder myViewHolder =
                new CommercialListingCustomAdapter.MyViewHolder(view, mListner);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(final CommercialListingCustomAdapter.MyViewHolder holder, final int listPosition) {
        ...
        viewButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                showListingDialog.setTitle("Commercial Listing");
                ...
                call.enqueue(new Callback<show_commertial>() {
                    ...
                    public void onResponse(Call<show_commertial> call, Response<show_commertial> response) {
                        ...
                        showCommercialObject = response.body();
                        ...
                        mMapView.getMapAsync(new OnMapReadyCallback() {
                            ...
                            public void onMapReady(final GoogleMap googleMap) {
                                Double lat = showCommercialObject.getAddress().getLat();
                                Double lng = showCommercialObject.getAddress().getLng();
                                ...
                                String chargerType = showCommercialObject.getChargerType().getChargerType();
                                if ("Standard Domestic Socket".equalsIgnoreCase(chargerType)) {
                                    connectorTypeOrSocket = showCommercialObject.getProvider().getSocket();
                                }else {
                                    connectorTypeOrSocket = showCommercialObject.getConnectorType().getConnectorType();
                                }

                                final String powerOutput = showCommercialObject.getProvider().getPowerOutput();
                                final String totalPrice = showCommercialObject.getProvider().getFinalPrice();
                        ...
                        if ("Standard Domestic Socket".equalsIgnoreCase(chargerType)) {
                            socketValueTextView.setText(showCommercialObject.getProvider().getSocket());
                        }

                        if ("Charging Station".equalsIgnoreCase(chargerType)) {
                            chargerBrandValueTextView.setText(showCommercialObject.getChargerBrand().getChargerBrand());
                            chargerModelValueTextView.setText(showCommercialObject.getChargerModel().getChargerModel());
                            connectorTypeValueTextView.setText(showCommercialObject.getConnectorType().getConnectorType());
                        }

                        electricityBoardValueTextView.setText(showCommercialObject.getProvider().getElectricity());
                        powerOutputValueTextView.setText(showCommercialObject.getProvider().getPowerOutput());
                        voltageValueTextView.setText(showCommercialObject.getProvider().getVoltage());
                        amphereValueTextView.setText(showCommercialObject.getProvider().getAmphere());
                        totalPriceValueTextView.setText(showCommercialObject.getProvider().getFinalPrice());
                        String selectedDays = showCommercialObject.getProvider().getDays();
                        daysValueTextView.setText(selectedDays);


                        //booking show
                        double booking = (showCommercialObject.getProvider().getInstantBooking());
                        if (booking == 0) {
                        ...
                        if (!TextUtils.isEmpty(selectedDays)) {
                            if (showCommercialObject.getProvider().getSingleDay() == 0) {
                                StringBuilder stringBuilder = new StringBuilder("");
                                int listSize = showCommercialObject.getStartTime().size();
                                for (int itemIndex = 0; itemIndex < showCommercialObject.getStartTime().size(); itemIndex++) {
                                    String startTime = showCommercialObject.getStartTime().get(itemIndex);
                                    String endTime = showCommercialObject.getEndTime().get(itemIndex);
                                ...
                                if (selectedDays.contains("monday")) {
                                    String selectedTimeValue = getSelectedTimeForDay(showCommercialObject.getStartTimeMon(), showCommercialObject.getEndTimeMon());
                                    mondayValueTextView.setText(selectedTimeValue);
                                    dayWithTimeStringBuilder.append("\n monday : " + selectedTimeValue);
                                }
                                if (selectedDays.contains("tuesday")) {
                                    String selectedTimeValue = getSelectedTimeForDay(showCommercialObject.getStartTimeTues(), showCommercialObject.getEndTimeTues());
                                    tuesdayValueTextView.setText(selectedTimeValue);
                                    dayWithTimeStringBuilder.append("\n tuesday : " + selectedTimeValue);
                                }
                                if (selectedDays.contains("wednesday")) {
                                    String selectedTimeValue = getSelectedTimeForDay(showCommercialObject.getStartTimeWed(), showCommercialObject.getEndTimeWed());
                                    wednesdayValueTextView.setText(selectedTimeValue);
                                    dayWithTimeStringBuilder.append("\n wednesday : " + selectedTimeValue);
                                }
                                if (selectedDays.contains("thursday")) {
                                    String selectedTimeValue = getSelectedTimeForDay(showCommercialObject.getStartTimeThus(), showCommercialObject.getEndTimeThus());
                                    thursdayValueTextView.setText(selectedTimeValue);
                                    dayWithTimeStringBuilder.append("\n thursday : " + selectedTimeValue);
                                }
                                if (selectedDays.contains("friday")) {
                                    String selectedTimeValue = getSelectedTimeForDay(showCommercialObject.getStartTimeFri(), showCommercialObject.getEndTimeFri());
                                    fridayValueTextView.setText(selectedTimeValue);
                                    dayWithTimeStringBuilder.append("\n friday : " + selectedTimeValue);
                                }
                                if (selectedDays.contains("saturday")) {
                                    String selectedTimeValue = getSelectedTimeForDay(showCommercialObject.getStartTimeSat(), showCommercialObject.getEndTimeSat());
                                    saturdayValueTextView.setText(selectedTimeValue);
                                    dayWithTimeStringBuilder.append("\n saturday : " + selectedTimeValue);
                                }
                                if (selectedDays.contains("sunday")) {
                                    String selectedTimeValue = getSelectedTimeForDay(showCommercialObject.getStartTimeSun(), showCommercialObject.getEndTimeSun());
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView, final CommercialListingCustomAdapter.ItemOnClickListner listner) {
            super(itemView);
