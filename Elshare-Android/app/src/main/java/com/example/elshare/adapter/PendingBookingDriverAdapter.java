...
import com.example.elshare.BookingHistoryDriverDetail;
...
public class PendingBookingDriverAdapter extends RecyclerView.Adapter <PendingBookingDriverAdapter.ViewHolder> {
    ...
    public PendingBookingDriverAdapter(Context context, ArrayList<String> orderNumber, ArrayList<String> totalAmount, ArrayList<String> bookingDate, ArrayList<String> bookingId, ArrayList<String> bookingCount, String roleString) {
        super();
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
        ...
        viewHolder.viewDetail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                Intent intent = new Intent(v.getContext(), BookingHistoryDriverDetail.class);
