...
import com.example.elshare.EditPublicListingActivity;
import com.example.elshare.R;
import com.example.elshare.list_public;
...
public class PublicListingCustomAdapter extends RecyclerView.Adapter<PublicListingCustomAdapter.MyViewHolder> {
    Dialog showListingDialog;
    private ArrayList<DataModel> dataSet;
    private PublicListingCustomAdapter.ItemOnClickListner mListner;
    private show_public showPublicObject;
    private StringBuilder dayWithTimeStringBuilder = new StringBuilder("");

    public PublicListingCustomAdapter(ArrayList<DataModel> data) {
        this.dataSet = data;
    }

    public void setItemOnClickListner(PublicListingCustomAdapter.ItemOnClickListner listner) {
        mListner = listner;
    }

    @Override
    public PublicListingCustomAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        PublicListingCustomAdapter.MyViewHolder myViewHolder =
                new PublicListingCustomAdapter.MyViewHolder(view, mListner);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(final PublicListingCustomAdapter.MyViewHolder holder, final int listPosition) {
        ...
        viewButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                showListingDialog.setTitle("Public Listing");
                ...
                call.enqueue(new Callback<show_public>() {
                    ...
                    public void onResponse(Call<show_public> call, Response<show_public> response) {
                        ...
                        showPublicObject = response.body();
                        ...
                        mMapView.getMapAsync(new OnMapReadyCallback() {
                            ...
                            public void onMapReady(final GoogleMap googleMap) {
                                Double lat = showPublicObject.getAddress().getLat();
                                Double lng = showPublicObject.getAddress().getLng();
                                ...
                                String chargerType = showPublicObject.getChargerType().getChargerType();
                                if ("Standard Domestic Socket".equalsIgnoreCase(chargerType)) {
                                    connectorTypeOrSocket = showPublicObject.getProvider().getSocket();
                                }else {
                                    connectorTypeOrSocket = showPublicObject.getConnectorType().getConnectorType();
                                }

                                final String powerOutput = showPublicObject.getProvider().getPowerOutput();
                                final String totalPrice = showPublicObject.getProvider().getFinalPrice();
                        ...
                        if ("Standard Domestic Socket".equalsIgnoreCase(chargerType)) {
                            socketValueTextView.setText(showPublicObject.getProvider().getSocket());
                        }

                        if ("Charging Station".equalsIgnoreCase(chargerType)) {
                            chargerBrandValueTextView.setText(showPublicObject.getChargerBrand().getChargerBrand());
                            chargerModelValueTextView.setText(showPublicObject.getChargerModel().getChargerModel());
                            connectorTypeValueTextView.setText(showPublicObject.getConnectorType().getConnectorType());
                        }

                        electricityBoardValueTextView.setText(showPublicObject.getProvider().getElectricity());
                        powerOutputValueTextView.setText(showPublicObject.getProvider().getPowerOutput());
                        voltageValueTextView.setText(showPublicObject.getProvider().getVoltage());
                        amphereValueTextView.setText(showPublicObject.getProvider().getAmphere());
                        totalPriceValueTextView.setText(showPublicObject.getProvider().getFinalPrice());
                        String selectedDays = showPublicObject.getProvider().getDays();
                        daysValueTextView.setText(selectedDays);


                        //booking show
                        double booking = (showPublicObject.getProvider().getInstantBooking());
                        if (booking == 0) {
                        ...
                        if (!TextUtils.isEmpty(selectedDays)) {
                            if (showPublicObject.getProvider().getSingleDay() == 0) {
                                StringBuilder stringBuilder = new StringBuilder("");
                                int listSize = showPublicObject.getStartTime().size();
                                for (int itemIndex = 0; itemIndex < showPublicObject.getStartTime().size(); itemIndex++) {
                                    String startTime = showPublicObject.getStartTime().get(itemIndex);
                                    String endTime = showPublicObject.getEndTime().get(itemIndex);
                                ...
                                if (selectedDays.contains("monday")) {
                                    String selectedTimeValue = getSelectedTimeForDay(showPublicObject.getStartTimeMon(), showPublicObject.getEndTimeMon());
                                    mondayValueTextView.setText(selectedTimeValue);
                                    dayWithTimeStringBuilder.append("\n monday : " + selectedTimeValue);
                                }
                                if (selectedDays.contains("tuesday")) {
                                    String selectedTimeValue = getSelectedTimeForDay(showPublicObject.getStartTimeTues(), showPublicObject.getEndTimeTues());
                                    tuesdayValueTextView.setText(selectedTimeValue);
                                    dayWithTimeStringBuilder.append("\n tuesday : " + selectedTimeValue);
                                }
                                if (selectedDays.contains("wednesday")) {
                                    String selectedTimeValue = getSelectedTimeForDay(showPublicObject.getStartTimeWed(), showPublicObject.getEndTimeWed());
                                    wednesdayValueTextView.setText(selectedTimeValue);
                                    dayWithTimeStringBuilder.append("\n wednesday : " + selectedTimeValue);
                                }
                                if (selectedDays.contains("thursday")) {
                                    String selectedTimeValue = getSelectedTimeForDay(showPublicObject.getStartTimeThus(), showPublicObject.getEndTimeThus());
                                    thursdayValueTextView.setText(selectedTimeValue);
                                    dayWithTimeStringBuilder.append("\n thursday : " + selectedTimeValue);
                                }
                                if (selectedDays.contains("friday")) {
                                    String selectedTimeValue = getSelectedTimeForDay(showPublicObject.getStartTimeFri(), showPublicObject.getEndTimeFri());
                                    fridayValueTextView.setText(selectedTimeValue);
                                    dayWithTimeStringBuilder.append("\n friday : " + selectedTimeValue);
                                }
                                if (selectedDays.contains("saturday")) {
                                    String selectedTimeValue = getSelectedTimeForDay(showPublicObject.getStartTimeSat(), showPublicObject.getEndTimeSat());
                                    saturdayValueTextView.setText(selectedTimeValue);
                                    dayWithTimeStringBuilder.append("\n saturday : " + selectedTimeValue);
                                }
                                if (selectedDays.contains("sunday")) {
                                    String selectedTimeValue = getSelectedTimeForDay(showPublicObject.getStartTimeSun(), showPublicObject.getEndTimeSun());
    ...
    public void showAlertDialog() {
        ...
        builder1.setMessage("Public Details \n\n Availability : \n" + dayWithTimeStringBuilder);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView, final PublicListingCustomAdapter.ItemOnClickListner listner) {
            super(itemView);
